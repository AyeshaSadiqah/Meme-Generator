...
const showmeme = document.getElementById('ShowMeme');
const telljoke = document.getElementById('TellJoke');
const randomquote = document.getElementById('RandomQuote');
const riddleme = document.getElementById('Riddleme');
...
function riddle(event) { 
  ...
  const secondButton = createButton("Reveal Answer",RevealAns);
...
showmeme.addEventListener('click',meme);
telljoke.addEventListener('click',  joke);
randomquote.addEventListener('click', quote);
riddleme.addEventListener('click', riddle);
